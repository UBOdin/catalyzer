...
trait DateTimeFormatterHelper {
  ...
  private def needConvertToSparkUpgradeException(e: Throwable): Boolean = false
  ...
  protected def checkParsedDiff[T](
    ...
    case e if needConvertToSparkUpgradeException(e) =>
      ...
      throw new SparkUpgradeException("3.0", s"Fail to parse '$s' in the new parser. ", e)
  }
  ...
  protected def checkLegacyFormatter(
    ...
    case e: IllegalArgumentException =>
      ...
      throw new SparkUpgradeException("3.0", s"Fail to recognize '$pattern' pattern in the" +
        s" DateTimeFormatter. You can form a valid datetime pattern" +
