...
public class JavaUtils {
  ...
  public static void closeQuietly(Closeable closeable) {
    try {
      ...
      System.err.println("IOException should not have been thrown."+e);
    }
  }
  ...
  public static void deleteRecursively(File file, FilenameFilter filter) throws IOException {
    ...
    if (SystemUtils.IS_OS_UNIX && filter == null) {
      try {
        ...
        System.err.println("Attempt to delete using native Unix OS command failed for path = {}. " +
                        "Falling back to Java IO way: "+file.getAbsolutePath()+"\n"+e);
      }
    }
